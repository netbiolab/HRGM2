...
if not os.path.isdir(depth_dir):
    os.system("mkdir "+depth_dir)
os.system("python3.7 /nbl/user/mjy1064/3_genome_assembly/2_binning/5_binning/1_metaBAT2/1_depth/depth_file.py "+sample_name+" "+sorted_bam_dir+" "+depth_dir+" "+min_contig_len)

bin_dir = '/nbl/user/mjy1064/3_genome_assembly/2_binning/5_binning/1_metaBAT2/2_binning/output_genome/'+cohort_name
if not os.path.isdir(bin_dir):
    os.system("mkdir "+bin_dir)
os.system("python3.7 /nbl/user/mjy1064/3_genome_assembly/2_binning/5_binning/1_metaBAT2/2_binning/metaBAT2.py "+sample_name+" "+assemble_res_dir+" "+depth_dir+" "+bin_dir+" "+min_contig_len+" "+thread+" "+assemblr_name)
